...
wanted = {
    ...
    'octanol_water_partition_coefficient': None,
    'organic_carbon_water_partition_coefficient': None,
    'air_water_partition_coefficient': None,
...
search_for = {
    ...
    'Log Kow (E' : 'octanol_water_partition_coefficient',
    'LogKoc' : 'organic_carbon_water_partition_coefficient',
    'Log Kaw' : 'air_water_partition_coefficient',
